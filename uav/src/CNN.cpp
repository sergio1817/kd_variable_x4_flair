...
{
    wc    = new Eigen::VectorXf(criticDoF);
    xc    = new Eigen::MatrixXf(DoF, DoF);
    xcp   = new Eigen::MatrixXf(DoF, DoF);
    J     = new Eigen::VectorXf(DoF);
    ec    = new Eigen::VectorXf(DoF);
    int_r = new Eigen::VectorXf(DoF);
